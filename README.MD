...
## Requirements
[appium-inspector](https://github.com/appium/appium-inspector/releases)<br>
[nodejs](https://nodejs.org/en/download/current)

> appium-doctor `npm install appium-doctor -g` <br>
...
### To install Appium from cmd
> `npm i appium@next` <-OR->`npm install -g appium`<br>
...
>> example :- `appium driver install uiautomator2` uiatomator2 is for android platforms.<br>
...
> - In the SDK Tools tab, select Android SDK API Level  > 33.
...
>> - device name will be emultor udid(id) get through `adb devices`
